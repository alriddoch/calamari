...
static float height[grid_width + 1][grid_height + 1] = {
  ...
  {-0.1f, 0.3f, 0.2f, 0.3f, 0.2f, 0.45f, 0.6f, 0.4f, 0.3f, 0.35f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.3f, 0.2f, 0.3f, 0.2f, 0.65f, 0.8f, 0.4f, 0.3f, 0.35f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.4f, 0.2f, 0.3f, 0.2f, 0.85f, 0.9f, 0.4f, 0.3f, 0.35f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.34f, 0.2f, 0.3f, 0.2f, 0.95f, 1.2f, 0.4f, 0.3f, 0.45f, 0.3f, 0.25f, 0.1f },
  {-0.1f, 0.45f, 0.2f, 0.3f, 0.2f, 1.2f, 1.3f, 0.4f, 0.3f, 0.55f, 0.4f, 0.25f, 0.1f },
  {-0.1f, 0.24f, 0.2f, 0.3f, 0.2f, 0.95f, 1.1f, 0.4f, 0.3f, 0.45f, 0.3f, 0.25f, 0.1f },
  {-0.1f, 0.22f, 0.2f, 0.3f, 0.2f, 0.75f, 0.9f, 0.4f, 0.3f, 0.35f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.20f, 0.2f, 0.3f, 0.2f, 0.55f, 0.7f, 0.4f, 0.3f, 0.35f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.15f, 0.2f, 0.3f, 0.2f, 0.45f, 0.6f, 0.4f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
  {-0.1f, 0.2f, 0.2f, 0.3f, 0.2f, 0.25f, 0.3f, 0.4f, 0.3f, 0.25f, 0.2f, 0.15f, 0.1f },
...
void draw_grid()
{
    ...
    for(int i = 0; i < grid_width; ++i) {
        for(int j = 0; j < grid_height; ++j) {
            if ((slots[i][j])) {
                glPushMatrix();
                glTranslatef(0.0f, 0.0f, height[i][j]);
                draw_unit_cube();
                glPopMatrix();
            }
            glTranslatef(0.0f, 1.0f, 0.0f);
    ...
    glPopMatrix();
    glTranslatef(0.0f, 0.0f, height[block_x][block_y]);
...
void camera_pos()
{
    ...
    glRotatef(360 * camera_rotation / (2 * M_PI), 0, 0, 1);
}
